        ...
        <div className="space-y-6">
          {processSteps.map((step, i) => (
            <Reveal key={step.number} delay={i * 60}>
              ...
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-indigo-500/10 text-lg font-bold text-indigo-400 ring-1 ring-indigo-500/20">
                  {step.number}
                </div>
                <div>
